...
from football_intelligence.data_mesh.reconciliation import MODEL_VERSION, reconcile_metric
...
def _coverage_by_source(observations: list[NormalizedObservation]) -> dict[str, dict[str, int]]:
