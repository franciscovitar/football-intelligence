...
_CERTIFIED_WYSCOUT_VERSION = "wyscout-open-v0.2"
...
def test_certified_pair_exact_policy_resolves_for_home_score() -> None:
    # wyscout-open-v0.2 + statsbomb-open-v0.4 -> current policies match.
...
def test_future_wyscout_version_bump_no_longer_matches() -> None:
    # wyscout-open-v0.3 + statsbomb-open-v0.4 (real, certified StatsBomb
    ...
    future_wyscout = SourceRef(
        source_code=WYSCOUT_SOURCE_CODE, semantic_version="wyscout-open-v0.3"
    )
    policy = comparability_policy(
...
def test_future_statsbomb_version_bump_no_longer_matches() -> None:
    # wyscout-open-v0.2 (real, certified Wyscout side) + statsbomb-open-v0.5
    # -> no old policy match.
...
def test_both_sources_future_bumped_no_longer_matches() -> None:
    # wyscout-open-v0.3 + statsbomb-open-v0.5 -> no old policy match.
    future_wyscout = SourceRef(
        source_code=WYSCOUT_SOURCE_CODE, semantic_version="wyscout-open-v0.3"
    )
    future_statsbomb = SourceRef(
